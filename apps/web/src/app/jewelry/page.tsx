...
export default function JewelryPage() {
  const items = getProductsByCategory("jewelry");
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="relative h-[70vh] min-h-[500px] bg-[#0A0A0A] overflow-hidden flex items-end">
        <img
          src="https://images.unsplash.com/photo-1515562141589-67f0d4e2b60b?w=1600&q=80"
          alt="Fine Jewelry"
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-[1440px] pb-16">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-5xl md:text-7xl font-heading text-white mb-3">Fine Jewelry</h1>
            <p className="text-white/50 font-light max-w-md">Heritage craftsmanship meets contemporary design. Each piece tells a story of timeless elegance.</p>
          </motion.div>
        </div>
      </section>
